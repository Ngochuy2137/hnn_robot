...
#include "hnn_robot_control/hnn_diff_robot_hardware.hpp"
...
{
hardware_interface::CallbackReturn HnnDiffRobotHardware::on_init(
  const hardware_interface::HardwareComponentInterfaceParams & params)
{
  ...
  // TODO: Add required parameters for Hnn Diff robot (serial port, baud rate, etc.)
  hw_start_sec_ =
  ...
  {
    // HnnDiffRobotHardware has velocity command interface and position/velocity state interfaces
...
hardware_interface::CallbackReturn HnnDiffRobotHardware::on_configure(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  // if (!initialize_hnn_diff_connection()) {
  //   return hardware_interface::CallbackReturn::ERROR;
  // }
...
hardware_interface::CallbackReturn HnnDiffRobotHardware::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
hardware_interface::CallbackReturn HnnDiffRobotHardware::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
hardware_interface::return_type HnnDiffRobotHardware::read(
...
hardware_interface::return_type HnnDiffRobotHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
...
PLUGINLIB_EXPORT_CLASS(
  hnn_robot_control::HnnDiffRobotHardware, hardware_interface::SystemInterface)
